  ...
  if ($connection) {
    ...
    switch ($_POST["tipo"]) {
      case "consumible":
        ...
        $result = $controller->updateElemento($codigo, $nombre, $area, $tipo, null, null, null, null, $cantidad, $medida);
      ...
      case "devolutivo":
        ...
        $result = $controller->updateElemento($codigo, $nombre, $area, $tipo, $placa, $serial, $marca, $modelo);
        if ($result) $output = $result;
        break;
